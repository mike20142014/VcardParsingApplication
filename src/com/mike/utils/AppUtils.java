...
public class AppUtils {
	...
	public final static String DEFAULT_DIR_STRING = Environment.getExternalStorageDirectory().getAbsolutePath() + "/interactivecalling";
	public final static String DEFAULT_LOG_DIR_STRING = DEFAULT_DIR_STRING + "/logs";
	...
	static {
        ...
        if(!DEFAULT_DIR.exists()) {
            ...
            if(!succeed) {
                System.out.println("Failed to create dir " + DEFAULT_DIR_STRING);
            }
        }
